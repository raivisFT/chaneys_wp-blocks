		...
		<div class="top-searchbox header-wrap-sbar" style="display:none">
			...
			<div class="search-input-wrapper navbar-item">
				<label class="navbar-item" for="search-close" id="search-close-label">
					...
					<form role="search" method="get" id="searchform" class="headerSearchForm" action="<?php echo esc_url( home_url( '/' ) ); ?>?s_post_type=news">
						<input type="search" id="search-input" name="s" value="<?php echo get_search_query(); ?>" placeholder="Enter your search term..." autocomplete="off" />
						<input type="radio" value="news" <?php echo esc_attr( $checked_news ); ?> name="s_post_type" style="display:none" checked>
